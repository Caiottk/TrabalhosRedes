...
public class UDPServerSocket {
    ...
    private ArrayList<UDPListener> listeners = new ArrayList<>();                              // List of listeners
    private HashMap<String, UDPSocket> sockets = new HashMap<>();                              // Hashmap of sockets
    private ConcurrentLinkedQueue<DatagramPacket> packetPool = new ConcurrentLinkedQueue<>();  // Pool of packets
    private Timer timer;
